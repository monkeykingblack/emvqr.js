...
describe('VietQRBUilderTest', () => {
  it('#testSuccessToString', () => {
    ...
    assert.equal(
      builder.toString(),
      '00020101021238510010A00000072701210006970432010789477750208QRIBFTTA53037045408888888.35802VN62120808Transfer6304388B',
    );
  });
  ...
  describe('#testThrowErrorWithNoValidConsumer', () => {
    it('should throw error invalid Bank', () => {
      ...
      assert.throws(
        () => builder.toString(),
        TypeError,
        'Bank 1234 not available. Please refer to VNBank enum',
      );
    });
    it('should throw error invalid Currency', () => {
      ...
      assert.throws(
        () => builder.toString(),
        TypeError,
        'Currency 1234 not available. Please refer to Currency enum',
      );
    });
    it('should throw error invalid Country', () => {
      ...
      assert.throws(
        () => builder.toString(),
        TypeError,
        'Country ab not available. Please refer to Country enum',
      );
    });
  });
});
